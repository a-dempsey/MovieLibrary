...
class MovieLib:
    ...
    def search(self, title):
        ...
        return BSTNode.search(self.bst, movieTitle)
    ...
    def add(self, title, date, runtime):
        ...
        if MovieLib.size(self) == 0:
            self.bst = BSTNode(movie)
        else:
             BSTNode.add(self.bst, movie)
    ...
    def remove(self, title):
        ...
        """
        mtitle = Movie(title)
        return BSTNode.remove(self.bst, mtitle)

    def _testadd():
        library = MovieLib()
        library.add("Memento", "11/10/2000", 113)
        print(str(library))
       # print(library.search('Memento'))
